...
var Student = function (_Person) {
        ...
        function Student(name, age) {
                var major = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "CSE";
...
var Traveller = function (_Person2) {
        ...
        function Traveller(name, age, homeLocations) {
                ...
                _this2.homeLocations = homeLocations;
                return _this2;
        }
        ...
        _createClass(Traveller, [{
                key: 'getGretting',
                value: function getGretting() {
                        var gretting = _get(Traveller.prototype.__proto__ || Object.getPrototypeOf(Traveller.prototype), 'getGretting', this).call(this);
...
var me = new Student('Saif Shovon');
console.log(me.getGretting());

var other = new Student("saif shovon", 26, "BBA");
console.log(other.getDescription());

var traveller = new Traveller("saif shovon", 26, "Magura");
